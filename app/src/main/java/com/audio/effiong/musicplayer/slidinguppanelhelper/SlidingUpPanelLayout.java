 ...
 */
package com.audio.effiong.musicplayer.slidinguppanelhelper;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private static boolean isAlbumActivity = false;
...
//    public SlidingUpPanelLayout(boolean flag) {
//       // this(context, flag);
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mMainView) {
                ...
                if(isAlbumActivity && Helpers.isAboveKitkat() ){
                                    if (height < 900) {  //SCREEN_HEIGHT = 900
                   /// height = height - 8;
                                        height = height - getStatusBarHeight();                  //MARGIN_BOTTOM = 8
                } else {
    ...
    public void setFlag(boolean flag){
        isAlbumActivity = flag;
    }

    public static void setFlagResume(boolean flag){
        isAlbumActivity = flag;
    }
}
