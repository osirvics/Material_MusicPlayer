...
public class SettingsActivity extends BaseThemedActivity implements ColorChooserDialog.ColorCallback, ATEActivityThemeCustomizer {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void invalidateSettings() {
            ...
            findPreference("dark_theme").setOnPreferenceChangeListener(
...
//
            ...
            final ATEPreference equaBarPref = (ATEPreference) findPreference("equalizer");
            equaBarPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
            ...
            final ATEPreference removeAds = (ATEPreference) findPreference("remove_ads");
            removeAds.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Helpers.openPlayStore(getActivity(),packageNamePro);
                    return true;
                }
            });
...
//            if (MusicPreference.getTheme(this).equals("dark"))
//                setTheme(R.style.AppThemeNormalDark);
//            else if (MusicPreference.getTheme(this).equals("black"))
